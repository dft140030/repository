...
%
%  SYNOPSIS: plotSpeckleSM(tassm,plotIndices)
%
%  INPUT: tassm: cell array of data to be plotted 
%  
%   plotIndices: cell array specifying specific indices to be plotted
%
%       figpath: path to import figures created
%
%  OUTPUT: testResults: vector of structures returning statistical test 
